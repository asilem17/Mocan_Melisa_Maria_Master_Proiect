...
namespace Mocan_Melisa_MariaMVC.Controllers
{
    public class BreedsController : Controller
    {
        ...
        public BreedsController(PetsAdoptionContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BreedName,AnimalType")] Breed breed)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BreedName,AnimalType")] Breed breed)
        {
            if (id != breed.Id)
            {
                return NotFound();
